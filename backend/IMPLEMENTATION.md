...
4. **Policy Q&A** uses Chroma. Run `python seed.py` to index candidate-authored `/policy_docs/*.md` once (skips placeholders and already-indexed files). Admin upload/delete still works for extra documents and acceptance test #12.
